...
func handleHTTP(o ServeOptions) *chi.Mux {
	...
	mux.Use(middleware.ResolveTenantFromRequestMiddleware(o.tenantManager, o.EnableDefaultTenant))
	...
	mux.Group(func(r chi.Router) {
		...
		r.Route("/wallet-registration", func(r chi.Router) {
			sep24QueryTokenAuthenticationMiddleware := anchorplatform.SEP24QueryTokenAuthenticateMiddleware(o.sep24JWTManager, o.NetworkPassphrase, o.tenantManager, o.EnableDefaultTenant)
			...
			sep24HeaderTokenAuthenticationMiddleware := anchorplatform.SEP24HeaderTokenAuthenticateMiddleware(o.sep24JWTManager, o.NetworkPassphrase, o.tenantManager, o.EnableDefaultTenant)
