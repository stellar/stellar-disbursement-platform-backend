...
func Test_ProfileHandler_PatchOrganizationProfile_Successful(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			wantLogEntries: []string{"[PatchOrganizationProfile] - userID user-id will update the organization fields [IsLinkShortenerEnabled='false', IsTenantMemoEnabled='false', OTPMessageTemplate='', PaymentCancellationPeriodDays='0', PrivacyPolicyLink='', ReceiverInvitationResendIntervalDays='0', ReceiverRegistrationMessageTemplate='']"},
		},
	}
