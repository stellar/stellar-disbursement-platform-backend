...
type TransactionStore interface {
	...
	GetTransactionBatchForUpdate(ctx context.Context, dbTx db.DBTransaction, batchSize int, tenantID string, transactionType string) (transactions []*Transaction, err error)
