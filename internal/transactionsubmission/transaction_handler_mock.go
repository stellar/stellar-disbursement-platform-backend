...
import (
	...
	events "github.com/stellar/stellar-disbursement-platform-backend/internal/events"
...
// BuildFailureEvent provides a mock function with given fields: ctx, txJob, err
func (_m *MockTransactionHandler) BuildFailureEvent(ctx context.Context, txJob *TxJob, err error) (*events.Message, error) {
	ret := _m.Called(ctx, txJob, err)

	if len(ret) == 0 {
		panic("no return value specified for BuildFailureEvent")
	}

	var r0 *events.Message
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *TxJob, error) (*events.Message, error)); ok {
		return rf(ctx, txJob, err)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *TxJob, error) *events.Message); ok {
		r0 = rf(ctx, txJob, err)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*events.Message)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *TxJob, error) error); ok {
		r1 = rf(ctx, txJob, err)
	} else {
		r1 = ret.Error(1)
	}
...
// BuildSuccessEvent provides a mock function with given fields: ctx, txJob
func (_m *MockTransactionHandler) BuildSuccessEvent(ctx context.Context, txJob *TxJob) (*events.Message, error) {
	ret := _m.Called(ctx, txJob)

	if len(ret) == 0 {
		panic("no return value specified for BuildSuccessEvent")
	}

	var r0 *events.Message
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *TxJob) (*events.Message, error)); ok {
		return rf(ctx, txJob)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *TxJob) *events.Message); ok {
		r0 = rf(ctx, txJob)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*events.Message)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *TxJob) error); ok {
		r1 = rf(ctx, txJob)
	} else {
		r1 = ret.Error(1)
	}
