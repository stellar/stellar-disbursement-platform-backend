...
The distribution account's balance is where the spending amount will be pulled from and also acts the [sponsored reserve](#https://developers.stellar.org/docs/encyclopedia/sponsored-reserves), used to pay the base reserve for any of its channel accounts that exist onchain.
