...
// AdjustLimitIfNeeded provides a mock function with given fields: err
func (_m *MockTransactionProcessingLimiter) AdjustLimitIfNeeded(err utils.TransactionError) {
	_m.Called(err)
}

// LimitValue provides a mock function with no fields
