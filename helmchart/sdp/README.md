...
| `sdp.image.tag`                                                    | Docker image tag for the SDP service. If set, this overrides the default value from `.Chart.AppVersion`.                                                       | `3.7.2`                                         |
...
| `sdp.configMap.data.EMBEDDED_WALLETS_RECOVERY_MASTER_PRIVATE_KEY`  | The master private key for multisig configuration of embedded wallets. Required when ENABLE_EMBEDDED_WALLETS is "true" and multisig is enabled.                |                                                 |
| `sdp.configMap.data.EMBEDDED_WALLETS_RECOVERY_COSIGNER_PUBLIC_KEY` | The cosigner public key for multisig configuration of embedded wallets. Required when ENABLE_EMBEDDED_WALLETS is "true" and multisig is enabled.               |                                                 |
...
| `sdp.configMap.data.RPC_REQUEST_AUTH_HEADER_KEY`                   | The name of the HTTP header to include when authenticating requests to a protected RPC server. Used together with RPC_REQUEST_AUTH_HEADER_VALUE.               |                                                 |
| `sdp.configMap.data.DISABLE_INITIAL_DISBURSEMENT_INVITATIONS`      | Determines if initial disbursement invitations should be disabled ("true" or "false").                                                                         | `false`                                         |
...
| `sdp.kubeSecrets.data.RPC_REQUEST_AUTH_HEADER_VALUE`               | The value of the HTTP header used for authenticating requests to a protected RPC server. Used together with RPC_REQUEST_AUTH_HEADER_KEY.                       |                                                 |
...
| `anchorPlatform.configMap.data.SEP45_ENABLED`                             | Determines if SEP-45 web authentication is enabled in Anchor Platform ("true" or "false").                                                                                                                                                                                                                               | `false`                                 |
| `anchorPlatform.configMap.data.SEP45_WEB_AUTH_CONTRACT_ID`                | The contract address for SEP-45 web authentication. Required when SEP45_ENABLED is "true".                                                                                                                                                                                                                               |                                         |
| `anchorPlatform.configMap.data.STELLAR_NETWORK_RPC_URL`                   | The URL of the Stellar RPC server. Required when SEP45_ENABLED is "true" or for embedded wallets support.                                                                                                                                                                                                                |                                         |
...
| `anchorPlatform.kubeSecrets.data.SECRET_SEP45_JWT_SECRET`                 | The JWT secret used by the Anchor Platform for SEP-45 web authentication. Required when SEP45_ENABLED is "true".                                                                                                                                                                                                         |                                         |
...
| `tss.configMap.data.RPC_URL`                                      | The URL of the Stellar RPC server for embedded wallets and SEP-45 features. Required when ENABLE_EMBEDDED_WALLETS or ENABLE_SEP45 is "true".                           |                   |
| `tss.configMap.data.RPC_REQUEST_AUTH_HEADER_KEY`                  | The name of the HTTP header to include when authenticating requests to a protected RPC server. Used together with RPC_REQUEST_AUTH_HEADER_VALUE.                       |                   |
...
| `tss.kubeSecrets.data.RPC_REQUEST_AUTH_HEADER_VALUE`              | The value of the HTTP header used for authenticating requests to a protected RPC server. Used together with RPC_REQUEST_AUTH_HEADER_KEY.                               |                   |
