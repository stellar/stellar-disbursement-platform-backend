...
| `sdp.image.tag`                                                         | Docker image tag for the SDP service. If set, this overrides the default value from `.Chart.AppVersion`.                                                                                             | `6.0.1`                                                            |
...
| `sdp.configMap.data.RPC_URL`                                            | The URL of the Stellar RPC server for embedded wallets and SEP-45 features. Required when ENABLE_EMBEDDED_WALLETS or ENABLE_SEP45 is "true". Defaults to the public Soroban RPC URL on testnet only. |                                                                    |
...
| `tss.configMap.data.RPC_URL`                                      | The URL of the Stellar RPC server for embedded wallets and SEP-45 features. Required when ENABLE_EMBEDDED_WALLETS or ENABLE_SEP45 is "true". Defaults to the public Soroban RPC URL on testnet only. |                   |
...
| `dashboard.image.fullName`                       | Full name of the Docker image.                                                                                                                     | `stellar/stellar-disbursement-platform-frontend:6.0.1` |
