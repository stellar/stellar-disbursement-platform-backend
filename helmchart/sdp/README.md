...
| `sdp.configMap.data.EMBEDDED_WALLETS_MULTISIG_ADMIN_ADDRESS`            | The admin address for multisig configuration of embedded wallets. Required when ENABLE_EMBEDDED_WALLETS is "true" and multisig is enabled.                     |                                                 |
| `sdp.configMap.data.EMBEDDED_WALLETS_MULTISIG_SECONDARY_SIGNER_ADDRESS` | The secondary signer address for multisig configuration of embedded wallets. Required when ENABLE_EMBEDDED_WALLETS is "true" and multisig is enabled.          |                                                 |
