...
| `sdp.image.tag`                                                         | Docker image tag for the SDP service. If set, this overrides the default value from `.Chart.AppVersion`.                                                        | `0.0.0-rc.1`                                                       |
...
| `dashboard.image.fullName`                       | Full name of the Docker image.                                                                                                                     | `stellar/stellar-disbursement-platform-frontend:0.0.0-rc.1` |
