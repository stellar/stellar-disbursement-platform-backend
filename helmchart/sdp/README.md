...
| `sdp.configMap.data.DB_MAX_OPEN_CONNS`                                  | Maximum open connections per pool to the database.                                                                                                             | `10`                                            |
| `sdp.configMap.data.DB_MAX_IDLE_CONNS`                                  | Maximum idle connections retained in the pool.                                                                                                                 | `0`                                             |
| `sdp.configMap.data.DB_CONN_MAX_IDLE_TIME_SECONDS`                      | Close idle connections after N seconds.                                                                                                                        | `2`                                             |
...
| `anchorPlatform.deployment.resources`                                     | Resource limits and requests for the Anchor Platform service pods. If not specified, falls back to global.resources.                                                                                                                                                                                                     | `{}`                                    |
...
| `tss.configMap.data.DB_MAX_OPEN_CONNS`                            | Maximum open connections per pool to the database.                                                                                                                     | `10`              |
| `tss.configMap.data.DB_MAX_IDLE_CONNS`                            | Maximum idle connections retained in the pool.                                                                                                                         | `0`               |
| `tss.configMap.data.DB_CONN_MAX_IDLE_TIME_SECONDS`                | Close idle connections after N seconds.                                                                                                                                | `2`               |
