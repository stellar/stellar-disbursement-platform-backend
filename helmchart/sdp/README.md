...
| `sdp.configMap.data.DISABLE_RECAPTCHA`                            | Default setting for ReCaptcha across all tenants ("true" or "false"). Can be overridden per organization via API/UI.                                           | `false`                                         |
| `sdp.configMap.data.DISABLE_MFA`                                  | Default setting for email-based MFA across all tenants ("true" or "false"). Can be overridden per organization via API/UI.                                    | `false`                                         |
