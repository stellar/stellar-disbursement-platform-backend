...
func Test_TenantHandler_Get(t *testing.T) {
	...
	t.Run("GetAll successfully returns a list of all tenants", func(t *testing.T) {
		...
		`,
			...
			*tnt1.DistributionAccountAddress, schema.DistributionAccountStellarDBVault, schema.DistributionAccountStatusActive,
			tnt2.ID, tnt2.Name, tnt2.CreatedAt.Format(time.RFC3339Nano), tnt2.UpdatedAt.Format(time.RFC3339Nano),
			*tnt2.DistributionAccountAddress, schema.DistributionAccountStellarDBVault, schema.DistributionAccountStatusActive,
			...
			*deactivatedTnt.DistributionAccountAddress, schema.DistributionAccountStellarDBVault, schema.DistributionAccountStatusActive,
		)
...
func Test_TenantHandler_Post(t *testing.T) {
	...
	t.Run("provisions a new tenant successfully", func(t *testing.T) {
		...
		`, tnt.ID, orgName, tnt.CreatedAt.Format(time.RFC3339Nano), tnt.UpdatedAt.Format(time.RFC3339Nano),
			distAcc, schema.DistributionAccountStellarEnv, schema.DistributionAccountStatusActive)
		assert.JSONEq(t, expectedRespBody, string(respBody))
