...
ALTER TABLE submitter_transactions ADD COLUMN status_new transaction_status_new;

-- Copy & transform data
UPDATE submitter_transactions SET status_new = 
CASE 
...
-- Drop the old column
ALTER TABLE submitter_transactions DROP COLUMN status;

-- Rename the new column
ALTER TABLE submitter_transactions RENAME COLUMN status_new TO status;
...
ALTER TABLE submitter_transactions ADD COLUMN status_old transaction_status_old;
...
ALTER TABLE submitter_transactions RENAME COLUMN status_old TO status;
