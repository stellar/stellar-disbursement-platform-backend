...
-- column updated_at
CREATE TRIGGER refresh_message_updated_at BEFORE UPDATE ON messages FOR EACH ROW EXECUTE PROCEDURE update_at_refresh();


-- +migrate Down
DROP TRIGGER refresh_message_updated_at ON messages;
