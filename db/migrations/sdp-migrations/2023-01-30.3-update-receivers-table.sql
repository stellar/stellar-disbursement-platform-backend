...
ALTER TABLE receivers RENAME COLUMN registered_at TO created_at;
...
-- column updated_at
CREATE TRIGGER refresh_receiver_updated_at BEFORE UPDATE ON receivers FOR EACH ROW EXECUTE PROCEDURE update_at_refresh();


-- +migrate Down
DROP TRIGGER refresh_receiver_updated_at ON receivers;
...
ALTER TABLE receivers RENAME COLUMN created_at TO registered_at;
