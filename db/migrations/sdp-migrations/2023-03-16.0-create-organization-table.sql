...
CREATE TRIGGER refresh_organization_updated_at BEFORE UPDATE ON organizations FOR EACH ROW EXECUTE PROCEDURE update_at_refresh();


-- +migrate Down

-- Table: organizations
DROP TRIGGER refresh_organization_updated_at ON organizations;
