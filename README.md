...
SEP24_JWT_EXPIRATION_SECONDS=300 # How long SEP24 tokens stay valid, in seconds
```
...
**Optional Variables:**
- `SEP24_JWT_EXPIRATION_SECONDS` - How long SEP24 tokens stay valid, in seconds. Defaults to 300. Values above 3600 log a warning at startup.
